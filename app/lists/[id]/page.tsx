...
import { ArrowLeft, Plus, Trash2, Film, Tv, GripVertical, Star, Clock } from "lucide-react"
import type { ContentList, ListItem, Content, Series } from "@/lib/types/database"
...
export default function ListDetailPage({ params }: ListDetailPageProps) {
  ...
  return (
    <div className="min-h-screen bg-background">
      <DashboardHeader />
      <main className="container mx-auto px-4 py-8">
        <Button variant="ghost" onClick={() => router.push("/lists")} className="mb-4">
            ...
            <DialogContent>
              ...
              <form onSubmit={handleAddItem} className="space-y-4">
                <div className="space-y-2">
                  <Label>Tipo</Label>
                  <Select value={addType} onValueChange={(v) => setAddType(v as "content" | "series")}>
                    <SelectTrigger>
                      <SelectValue />
                    </SelectTrigger>
                    <SelectContent>
        ...
        {items.length === 0 ? (
          <Card>
            <CardContent className="flex flex-col items-center justify-center py-16">
              ...
              <p className="text-muted-foreground mb-4">Adicione conteúdos ou séries a esta lista</p>
