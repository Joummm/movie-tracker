      ...
      <main className="container mx-auto p-4 md:p-6 lg:p-8">
        ...
        <div className="grid gap-6 lg:grid-cols-3">
            ...
            <Card>
              ...
              <CardContent className="p-6">
                ...
                {finalContent.type === "episode" && (
                  <div className="mb-4">
                    ...
                    <p className="text-sm font-medium">
                      Temporada {finalContent.season}, Episódio{" "}
                      {finalContent.episode}
                    </p>
                  </div>
                )}
                ...
                <div className="space-y-2">
                  ...
                  <p className="text-sm font-medium">
                    {new Date(finalContent.watched_date).toLocaleDateString(
                      "pt-PT",
                      {
                        weekday: "long",
                        day: "numeric",
          ...
          <div className="lg:col-span-2 space-y-6">
              ...
              <div>
                ...
                {finalContent.series && finalContent.type === "episode" && (
                  <p className="text-lg text-muted-foreground">
                    {finalContent.series.name} • S{finalContent.season}E
                    {finalContent.episode}
                  </p>
                )}
                {finalContent.podcast &&
                  finalContent.type === "podcast_episode" && (
                    <p className="text-lg text-muted-foreground">
            ...
            {finalContent.type !== "podcast_episode" &&
              finalContent.content_actors &&
              finalContent.content_actors.length > 0 && (
                <Card>
                  <CardContent className="p-6">
                    <div className="flex items-center gap-2 mb-4">
              ...
              <CardContent className="p-6">
                ...
                <div className="grid gap-4 sm:grid-cols-2">
                  <div>
                    ...
                    <p className="font-medium">
                      {new Date(finalContent.created_at).toLocaleDateString(
                        "pt-PT",
                      )}
                    </p>
                  </div>
                  <div>
                    ...
                    <p className="font-medium">
                      {new Date(finalContent.updated_at).toLocaleDateString(
                        "pt-PT",
                      )}
                    </p>
                  </div>
