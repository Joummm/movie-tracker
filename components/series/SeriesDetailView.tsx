          ...
          <div className="p-6">
              ...
              <div className="space-y-6">
                ...
                {series.description && (
                  <div className="bg-linear-to-br from-card to-card/80 rounded-xl border border-border/30 p-6">
                    <h3 className="font-semibold text-lg mb-4">Sobre a Série</h3>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  ...
                  <div className="bg-linear-to-br from-primary/5 to-blue-500/5 rounded-xl border border-border/30 p-6">
                    <h3 className="font-semibold text-lg mb-4">Informações da Série</h3>
                    <div className="space-y-4">
                      <div>
                        <p className="text-sm text-muted-foreground">Ano de Lançamento</p>
                        <p className="font-medium">{series.release_year || "Não especificado"}</p>
                      </div>
                      ...
                      <div>
                        ...
                        <p className="font-medium">{Math.round(series.stats.total_watch_time / 60)}h</p>
                      </div>
                  ...
                  <div className="bg-linear-to-br from-muted/20 to-muted/10 rounded-xl border border-border/30 p-6">
                    ...
                    <div className="space-y-4">
                      ...
                      <div>
                        ...
                        <p className="font-medium">
                          {new Date(series.updated_at).toLocaleDateString('pt-PT')}
                        </p>
                      </div>
                      
                      {(series.would_recommend !== null || series.would_rewatch !== null || series.has_special_seasons) && (
                        <div>
                          <p className="text-sm text-muted-foreground mb-2">Preferências</p>
                          <div className="flex flex-wrap gap-2">
                            {series.would_recommend !== null && (
                              <span className={`px-2 py-1 rounded text-xs ${series.would_recommend ? 'bg-emerald-500/20 text-emerald-600' : 'bg-rose-500/20 text-rose-600'}`}>
                                {series.would_recommend ? '✓ Recomendaria' : '✗ Não recomendaria'}
                              </span>
                            )}
                            {series.would_rewatch !== null && (
                              <span className={`px-2 py-1 rounded text-xs ${series.would_rewatch ? 'bg-emerald-500/20 text-emerald-600' : 'bg-rose-500/20 text-rose-600'}`}>
            ...
            <TabsContent value="stats" className="m-0">
              <div className="space-y-6">
                {/* Main Stats Card */}
                <div className="bg-linear-to-br from-card to-card/80 rounded-xl border border-border/30 p-6">
                  <h3 className="font-semibold text-lg mb-6">Estatísticas Detalhadas</h3>
                  ...
                  <div className="space-y-6">
                    ...
                    <div>
                      ...
                      <div className="h-2.5 bg-muted/50 rounded-full overflow-hidden">
                        <div 
                          ...
                          style={{ width: `${series.stats.completion_percentage}%` }}
                        />
                      </div>
                      <div className="flex justify-between text-xs text-muted-foreground mt-2">
                        <span>{series.stats.watched_episodes} assistidos</span>
                        <span>{series.stats.total_episodes - series.stats.watched_episodes} restantes</span>
                      </div>
                    </div>
                    ...
                    <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                      <div className="space-y-2">
                        ...
                        <div className="text-xs text-muted-foreground">
                          {series.stats.total_seasons - series.stats.watched_seasons} restantes
                        </div>
                      </div>
                    ...
                    <div>
                      <div className="flex justify-between text-sm mb-2">
                        <span className="text-muted-foreground">Temporadas Concluídas</span>
                      ...
                      <div className="h-2.5 bg-muted/50 rounded-full overflow-hidden">
                        <div 
                          ...
                          style={{ 
                            width: series.stats.total_seasons > 0 
