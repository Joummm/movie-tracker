...
export function PodcastForm({ podcast, userId, isEdit = false }: PodcastFormProps) {
    ...
    <div className="max-w-2xl mx-auto">
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            {isEdit ? "Atualize as informações do podcast" : "Preencha as informações do podcast"}
          </CardDescription>
        </CardHeader>
        <CardContent>
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div className="space-y-2">
              ...
              <Select
                ...
                onValueChange={(value) => setFormData({ ...formData, status: value as PodcastStatus })}
              >
                <SelectTrigger>
                  <SelectValue />
                </SelectTrigger>
            ...
            <div className="flex gap-2 justify-end">
              ...
              <Button type="submit" disabled={isLoading}>
                {isLoading ? "Salvando..." : isEdit ? "Atualizar" : "Criar Podcast"}
              </Button>
            </div>
          </form>
        </CardContent>
